...
public class Passenger {
    public static int count1 = 0, count2 = 0, count3 = 0, count4 = 0, count5 = 0,count6 = 0 , full = 6600, num = 0;
    public static FuelQueue[] array1 = new FuelQueue[6]; //Queue 1
    public static FuelQueue[] array2 = new FuelQueue[6]; //Queue 2
    public static FuelQueue[] array3 = new FuelQueue[6]; //Queue 3
    public static FuelQueue[] array4 = new FuelQueue[6]; //Queue 4
    public static FuelQueue[] array5 = new FuelQueue[6]; //Queue 5
    public static FuelQueue[] waiting = new FuelQueue[1000]; //Waiting Queue
